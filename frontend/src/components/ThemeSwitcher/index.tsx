                              ...
                              <div key={themeKey}>
                                 ...
                                 >
                                    <div className="w-full h-full overflow-hidden rounded-md">
                                       {themeImages[`/src/assets/images/themes/${theme}.png`] !== undefined && (
                                          <img
                                 ...
                                 <div className="mt-2.5 capitalize text-center text-xs">{theme}</div>
                              </div>
                           ))}
                        </div>
                     </div>
                        ...
                        <div className="mt-5 grid grid-cols-3 gap-x-5 gap-y-3.5">
                           {layouts.map((layout, layoutKey) => (
                              <div key={layoutKey}>
                                 ...
                                 >
                                    <div className="w-full h-full overflow-hidden rounded-md">
                                       {layoutImages[`/src/assets/images/layouts/${layout}.png`] !== undefined && (
                                          <img
                                             className="w-full h-full"
                                 ...
                                 <div className="mt-2.5 capitalize text-center text-xs">{layout.replace('-', ' ')}</div>
                              </div>
                           ))}
                        </div>
                     </div>
                                 ...
                                 >
                                    <div className="h-full overflow-hidden rounded-full">
                                       <div className="flex items-center h-full gap-1 -mx-2">
                                          <div
                                             className={clsx(['w-1/2 h-[140%] bg-theme-1 rotate-12', colorScheme])}
                                          ></div>
                                          <div
                                             className={clsx(['w-1/2 h-[140%] bg-theme-2 rotate-12', colorScheme])}
                                          ></div>
                                       </div>
                                    </div>
                                 </div>
