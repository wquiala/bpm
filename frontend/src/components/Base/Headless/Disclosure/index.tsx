...
function Disclosure({
   ...
   return (
      <HeadlessDisclosure
         as="div"
         defaultOpen={group.selectedIndex === key || props.defaultOpen}
         className={twMerge([
...
const DisclosureButton = ({ children, className, ...props }: ExtractProps<typeof HeadlessDisclosure.Button>) => {
...
const DisclosurePanel = ({ children, className, ...props }: ExtractProps<typeof HeadlessDisclosure.Panel>) => {
   return (
      <Transition
         as={Fragment}
      ...
      >
         <HeadlessDisclosure.Panel
            as="div"
            className={twMerge(['mt-3 text-slate-700 leading-relaxed dark:text-slate-400', className])}
            {...props}
         >
            {children}
         </HeadlessDisclosure.Panel>
