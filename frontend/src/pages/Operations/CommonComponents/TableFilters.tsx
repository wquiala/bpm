   ...
   return (
      <div className="flex flex-col sm:flex-row sm:items-end xl:items-start">
         ...
         >
            <div className="items-center sm:flex sm:mr-4">
               ...
               >
                  ...
                  <option value="TotalRegistros">Total de registros</option>
                  <option value="RegistrosOk">Registros correctos</option>
                  <option value="RegistrosError">Registros con error</option>
               </FormSelect>
            </div>
         ...
         <div className="flex mt-5 sm:mt-0">
            <Button id="tabulator-print" variant="outline-secondary" className="w-1/2 mr-2 sm:w-auto" onClick={onPrint}>
