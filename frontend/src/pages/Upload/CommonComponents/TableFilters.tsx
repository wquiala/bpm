...
const TableFilters = ({ filter, setFilter, onFilter, onResetFilter, onPrint, onExportCsv, onExportJson, onExportXlsx, onExportHtml }: Props) => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-end xl:items-start">
            ...
            >
                <div className="items-center sm:flex sm:mr-4">
                    ...
                    >
                        <option value="Tipo">{t("type")}</option>
                        <option value="TotalRegistros">{t("totalRecords")}</option>
                        <option value="RegistrosOk">{t("okRecords")}</option>
                        <option value="RegistrosError">{t("errorRecords")}</option>
                    </FormSelect>
                </div>
