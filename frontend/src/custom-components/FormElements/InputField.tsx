...
const InputField = ({ control, name, type = "text", labelEnabled = true, info, label, placeholder, disabled = false, showIcon = false, icoName = "Bone", animationDirection = "intro-x", disableM = false, accept }: Props) => {
