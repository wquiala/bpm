...
export const createContractObservation = async (req: Request, res: Response) => {
   ...
   try {
      const createdContractObservation = await prismaClient.detalleObservacion.create({
         data: {
            Usuario: {
               connect: {
                  //@ts-ignore
...
export const updateContractObservation = async (req: Request, res: Response) => {
   ...
   try {
      const updatedContractObservation = await prismaClient.detalleObservacion.update({
         where: {
            ObservacionId: parseInt(req.params.id),
         },
         data: {
